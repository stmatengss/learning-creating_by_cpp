...
# 1 "/usr/include/c++/4.8/utility" 1 3 4
# 58 "/usr/include/c++/4.8/utility" 3 4
...
# 1 "/usr/include/c++/4.8/cstdlib" 1 3 4
# 39 "/usr/include/c++/4.8/cstdlib" 3 4
...
# 1 "/usr/include/c++/4.8/memory" 1 3 4
# 46 "/usr/include/c++/4.8/memory" 3 4
...
#pragma GCC visibility pop
# 72 "/usr/include/c++/4.8/memory" 2 3
...
# 56 "/usr/include/c++/4.8/functional" 2 3
...
# 80 "/usr/include/c++/4.8/memory" 2 3
...
# 15 "/usr/include/boost/get_pointer.hpp" 2 3 4
...
# 15 "/usr/include/boost/smart_ptr/scoped_ptr.hpp" 3 4
...
# 18 "/usr/include/boost/smart_ptr/scoped_ptr.hpp" 2 3 4
...
namespace boost
{
# 41 "/usr/include/boost/smart_ptr/scoped_ptr.hpp" 3 4
...
public:
    ...
    void reset(T * p = 0)
    {
        ((p == 0 || p != px) ? static_cast<void> (0) : __assert_fail ("p == 0 || p != px", "/usr/include/boost/smart_ptr/scoped_ptr.hpp", 87, __PRETTY_FUNCTION__));
        this_type(p).swap(*this);
    }

    T & operator*() const
    {
        ((px != 0) ? static_cast<void> (0) : __assert_fail ("px != 0", "/usr/include/boost/smart_ptr/scoped_ptr.hpp", 93, __PRETTY_FUNCTION__));
        return *px;
    }

    T * operator->() const
    {
        ((px != 0) ? static_cast<void> (0) : __assert_fail ("px != 0", "/usr/include/boost/smart_ptr/scoped_ptr.hpp", 99, __PRETTY_FUNCTION__));
        return px;
    }
...
# 110 "/usr/include/boost/smart_ptr/scoped_ptr.hpp" 2 3 4
...
template<class T> inline bool operator==( scoped_ptr<T> const & p, boost::detail::sp_nullptr_t ) noexcept
{
    return p.get() == 0;
}

template<class T> inline bool operator==( boost::detail::sp_nullptr_t, scoped_ptr<T> const & p ) noexcept
{
    return p.get() == 0;
}
